...
Connection con = DBconnection.getConnection();
  ...
  //  @Override
   ...
   //     }
    ...
    @Override
    public boolean isUserValid(String customer_LoginID, String customer_Password) {
        try{
            
            PreparedStatement preparedStatement = con.prepareStatement("select * from customer where customer_LoginID=? and customer_Password=?");
            preparedStatement.setString(1, customer_LoginID);

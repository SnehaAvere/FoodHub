...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             String customer_LoginID, customer_Password;
           customer_LoginID = request.getParameter("customer_LoginID");
           customer_Password = request.getParameter("customer_Password");
             CustomerDAO custDAO = new CustomerDAOImpl();
       // int count = custDAO.addCustomer(new Customer(
            RequestDispatcher rd = null;
            if(custDAO.isUserValid(customer_LoginID,customer_Password)){
